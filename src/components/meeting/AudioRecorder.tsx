...
import { Mic, MicOff, Pause, Play, Square, Loader2, RefreshCw, ChevronDown, Smartphone, CheckCircle2 } from "lucide-react";
...
export type AudioCaptureMode = "physical";
...
export default function AudioRecorder({ meetingId, onTranscribed }: Props) {
  const [captureMode] = useState<AudioCaptureMode>("physical");
...
const stopAllStreams = useCallback(() => {
  ...
  const start = useCallback(async (_mode: AudioCaptureMode) => {
    setError(null);
    ...
    try {
      ...
      if (msg.includes("Permission denied") || msg.includes("NotAllowedError")) {
        setError("Microfoon geblokkeerd — controleer de toestemming in je browser.");
      } else {
